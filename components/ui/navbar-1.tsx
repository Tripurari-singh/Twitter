...
const Navbar1 = () => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4 bg-black" >
      <div className="flex items-center justify-between px-6 py-3 bg-white -inset-1 rounded-full shadow-lg w-full max-w-3xl relative z-10">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {["Trending", "Posts"].map((item) => (
              ...
              >
                <a href="#" className="text-lg text-gray-900 hover:text-gray-600 transition-colors font-bold">
                  {item}
                </a>
              </motion.div>
            ))}
